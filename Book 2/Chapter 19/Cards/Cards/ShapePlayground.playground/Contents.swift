...
class MyViewController : UIViewController {
    ...
    override func loadView() {
        ...
        // квадрат
        //view.layer.addSublayer(SquareShape(size: CGSize(width: 350, height: 150), fillColor: UIColor.gray.cgColor))
        // крест
        //view.layer.addSublayer(CrossShape(size: CGSize(width: 250, height: 150), fillColor: UIColor.gray.cgColor))
        // закрашенный слой
        //view.layer.addSublayer(FillShape(size: CGSize(width: 250, height: 150), fillColor: UIColor.gray.cgColor))
        // рубашка 1
        //view.layer.addSublayer(BackSideCircle(size: CGSize(width: 150, height: 150), fillColor: UIColor.gray.cgColor))
        // рубашка 2
        //view.layer.addSublayer(BackSideLine(size: CGSize(width: 150, height: 150), fillColor: UIColor.gray.cgColor))
        ...
        let secondCardView = CardView<SquareShape>(frame: CGRect(x: 100, y: 0, width: 70, height: 90), color: .blue)
...
//        Array(0...Int(self.view.frame.width))
//        for _ in 1...16 {
//
//            let x = Array(0...300).randomElement()!
//            let y = Array(0...500).randomElement()!
//            let fillCardView = CardView<FillShape>(frame: CGRect(x: x, y: y, width: 70, height: 90), color: .black)
//            self.view.addSubview(fillCardView)
//        }
    }
}
